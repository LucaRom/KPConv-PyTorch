...
# omission 1
ply_file = "/mnt/SN750/00_Donnees_SSD/02_CCCOT/results_stjohns_random/Log_2022-06-01_03-19-50/predictions/NL_StJohns_20210205_NAD83CSRS_UTMZ22_1km_E3530_N52640_CQL1_CLASS.ply"

# omission 2
#ply_file = "/mnt/SN750/00_Donnees_SSD/02_CCCOT/results_stjohns_random/Log_2022-06-01_03-19-50/predictions/NL_StJohns_20210205_NAD83CSRS_UTMZ22_1km_E3620_N52660_CQL1_CLASS.ply"

# ouvrir ply
original_ply = read_ply(ply_file)

# Initiate containers
cloud_x = original_ply['x'] # class 'numpy.ndarray' , dtype('float64')
cloud_y = original_ply['y']
cloud_z = original_ply['z']
cloud_targets = original_ply['targets']
cloud_preds = original_ply['preds']
...
# Adding new field for errors
errors = cloud_targets == cloud_preds
errors = errors.astype(np.int32)

# Save as ply with new field
output_path = '/mnt/SN750/00_Donnees_SSD/02_CCCOT/results_stjohns_random/Log_2022-06-01_03-19-50/predictions_errors/'
field_names = ['x', 'y', 'z', 'targets', 'preds', 'errors']
write_ply(os.path.join(output_path + ply_file[-68:-4]) + '_errors.ply', [cloud_points, cloud_targets, cloud_preds, errors], field_names)
