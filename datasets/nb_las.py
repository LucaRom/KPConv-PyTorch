...
class NPM3DDataset(PointCloudDataset):
    ...
    def __init__(self, config, set='training', use_potentials=True, load_data=True):
        ...
        self.path = '/KPConv-PyTorch/raw_nb'
        ...
        self.cloud_names = ['299-5030', '300-5029', '301-5026', '301-5029', 
                            '302-5028', '305-5026', '305-5027', '305-5035', 
                            '306-5032', '306-5033', '308-5033', '300-5027',
                            '301-5028', '303-5029', '304-5030', '305-5032',
                            '309-5033']

        # very clunky # TODO
        self.all_splits = list(range(len(self.cloud_names)))
        self.validation_split = 11
        self.test_splits = [12, 13, 14, 15, 16]
        self.train_splits = list(range(11))
